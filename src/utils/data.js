export const testimonials = [
  {
    name: "Eloise Smith",
    role: "Industrial Engineer and CEO",
    company: "INDUX",
    image: "/assets/customers/testimonial1-2.jpg",
    feedback:
      "Rasyom Limited did an excellent job from the conceptual stage through the finished construction of our new office.",
  },
  {
    name: "Thomas Smith",
    role: "Industrial Engineer and CEO",
    ...
    feedback:
      "Their professionalism, dedication, and timely delivery exceeded our expectations.",
  },
  {
    name: "Vincent Smith",
    role: "Industrial Engineer and CEO",
    ...
    feedback:
      "Working with Rasyom Limited was smooth. They truly understand client needs and deliver quality.",
  },
  {
    name: "Thomas Smith",
    role: "Industrial Engineer and CEO",
...
export const projects = [
  {
    title: "Highway Construction – Abuja",
    image:
      "/assets/gallery/heavy-machines-construction-workers-working-building.jpg",
    description:
      "Completed 25km of durable road network connecting communities.",
  },
  {
    title: "Bridge Project – Lagos",
    image: "/assets/gallery/bridge-construction-site.jpg",
    description:
      "A modern bridge built to enhance safety and improve traffic flow.",
  },
  {
    title: "Commercial Building – Port Harcourt",
    image: "/assets/gallery/building-concrete-house.jpg",
    description:
      "A multi-purpose commercial complex designed for business growth.",
  },
];
