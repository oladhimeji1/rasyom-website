      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Duis aute irure dolor inasfa in voluptate velit esse cillum
            </p>
            <div className="space-y-2">
              <p className="text-gray-300">10 (87) 738-3940</p>
              <p className="text-gray-300">info@construction.com</p>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-300 hover:text-white">Drone Mapping</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white">Real Estate</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white">Commercial</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white">Construction</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            ...
            <Link href="https://colorlib.com" className="text-primary-400 hover:text-primary-300">
              Colorlib
            </Link>
          </p>
        </div>
